...
- 2026-05-21 **옵션 A Phase 1 완료**: Flyway V1~V5 폐기, 신규 V1 = DBv5.sql 통째(broken index/trigger 2건만 정정), `application-prod.yml` 에 `baseline-on-migrate=true` + `baseline-version="1"` 설정. Phase 2~9 (entity/repo/service/test 의 username/UserIdentity/UserRecipe rename + Long→Integer) 진행 예정.
