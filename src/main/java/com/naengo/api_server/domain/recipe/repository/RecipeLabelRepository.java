...
public interface RecipeLabelRepository extends JpaRepository<RecipeLabel, Integer> {
    ...
    @Query("""
           ...
           """)
    List<RecipeLabel> findByRecipeIds(@Param("recipeIds") Collection<Integer> recipeIds);
}
